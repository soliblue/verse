...
def parser() -> argparse.ArgumentParser:
    ...
    collect.add_argument("--sources", type=Path, default=Path(os.environ.get("MORROW_SOURCES_FILE", "etl/sources.json")))
    ...
    nightly.add_argument("--sources", type=Path, default=Path(os.environ.get("MORROW_SOURCES_FILE", "etl/sources.json")))
